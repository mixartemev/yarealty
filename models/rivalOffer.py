...
class RivalOffer(Base):
    ...
    category = Column(Enum("office", "shoppingArea", "flat", "freeAppointmentObject", name='category'))
    ...
    services = Column(Enum("top3", "paid", "premium", name='services'))
    userTrust = Column(Enum("involved", "notInvolved", "new", "excluded", name='userTrust'))
